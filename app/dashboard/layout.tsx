...
export default function DashboardLayout({
  ...
  return (
    <div style={{display: 'flex', minHeight: '100vh', backgroundColor: '#020617'}}>
      {/* Sidebar */}
      <div style={{width: '250px', backgroundColor: '#0f172a', borderRight: '1px solid #1e293b', padding: '1.5rem', display: 'flex', flexDirection: 'column'}}>
        ...
        <div style={{marginTop: 'auto'}}>
          <div style={{padding: '1rem', backgroundColor: '#1e293b', borderRadius: '0.5rem', marginBottom: '1rem'}}>
          ...
          <SignOutButton>
            <button style={{width: '100%', padding: '0.75rem', backgroundColor: '#ef4444', color: 'white', border: 'none', borderRadius: '0.5rem', cursor: 'pointer', fontWeight: '500'}}>
              Sign Out
            </button>
          </SignOutButton>
        </div>
