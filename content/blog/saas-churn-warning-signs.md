...
1. Calculate a composite risk score for every customer daily based on all five signals
2. Trigger the right intervention (email, SMS, Slack alert to CSM) at the right time automatically
3. Track which interventions worked and tune thresholds accordingly
4. Alert the team to VIP customers who need human attention
